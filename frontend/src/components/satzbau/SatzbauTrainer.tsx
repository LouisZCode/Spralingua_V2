            ...
            <div className="mt-5 flex min-h-[72px] flex-wrap items-center justify-center gap-2 rounded-[18px] border-[3px] border-dashed border-ink-faint bg-paper-warm p-4">
              ...
              {placedIdx.map((chipI, pos) => (
                <button
                  ...
                  className="btn-3d rounded-[14px] border-[3px] border-flag-red-deep bg-flag-red px-3.5 py-1.5 font-display text-[16px] font-black text-white"
                >
                  {item.chips[chipI]}
                </button>
              ))}
            ...
            <div className="mt-4 flex min-h-[52px] flex-wrap items-center justify-center gap-2">
              {trayIdx.map((chipI) => (
                <button
                  ...
                  className="btn-3d rounded-[14px] border-[3px] border-ink bg-white px-3.5 py-1.5 font-display text-[16px] font-black text-ink hover:bg-paper-warm"
                >
                  {item.chips[chipI]}
                </button>
              ))}
        ...
        {!solved ? (
          <div className="mt-6 flex flex-col items-center gap-3">
            <button
              ...
              className="btn-3d inline-flex items-center justify-center rounded-[18px] border-[3px] border-flag-red-deep bg-flag-red px-7 py-3 font-display text-[13px] font-black uppercase tracking-[0.16em] text-white disabled:pointer-events-none disabled:opacity-40"
              style={redShadow}
            >
              {busy ? "Checking…" : "Check"}
            </button>
